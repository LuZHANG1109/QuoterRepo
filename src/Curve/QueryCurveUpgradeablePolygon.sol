...
import {QueryCurveUpgradeableV2, ICurveMetaRegister, ICurveV2Pool, ICurvePool, ICurveNGPool, IAddressProvider, TokenInfo, IERC20} from "./QueryCurveUpgradeable.sol";
...
contract QueryCurveUpgradeablePolygon is QueryCurveUpgradeableV2 {
    ...
    function get_tokens_with_decimals(
        address pool
    ) public view override returns (TokenInfo[8] memory tokenInfos) {
